...
function hospedar(){
    ...
    var preVisu = document.querySelector("#preVisu")
    var p = document.createElement("p")
    p.innerHTML = "NOME DO HÓSPEDE: " + nome + "<br> CPF: " + cpf + " <br> DATA DE SAÍDA : " + saida + " <br> VALOR A SER PAGO R$: " + quanto(entrada,saida);
    preVisu.appendChild(p)
